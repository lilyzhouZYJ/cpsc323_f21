...
const char checkstr[] = "lemon\n";

// Check that read-only data cannot be executed

// If executed, the proccess will exit with an exit code of 99
const char code_as_data[] = {
